            ...
            <div className="SectionFive">
                <div className="SectionTwoMain">
                    <div className="SectionTwoMain_top">
                        ...
                        <MenuItem show={this.state.show} id={6} delay={2} icon={''} title={'Retail'} text={"Smart.bid's Predictive hub is constantly gathering data from both loyalty and less frequent customers activity, creating rich and ever-evolving customer profiles to yield a unique predictive customer status."}/>
                    </div>
