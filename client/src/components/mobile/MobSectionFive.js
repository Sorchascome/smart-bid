        ...
        <div className='sectionfive'>
            ...
            <div className="SectionFive">
                <div className="SectionTwoMain">
                    ...
                    <MenuItem id={7} delay={3} icon={''} title={'Services for Brands'} text={'With Smart.bid, you can place AI-powered decision making at the heart of your brand choices, to fuel better conversion rates and improved customer retention.'}/>
                </div>
            </div>
