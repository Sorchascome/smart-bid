exports.componentAppears = (Component, scroll_func) => {
    ...
    let elemStart = Math.abs(element.getBoundingClientRect().y - prevElemH/3 - document.body.getBoundingClientRect().y);
    let elemEnd = Math.abs((element.getBoundingClientRect().y + element.getBoundingClientRect().height/3) - document.body.getBoundingClientRect().y);
